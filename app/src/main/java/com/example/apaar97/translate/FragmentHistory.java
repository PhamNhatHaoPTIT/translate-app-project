...
public class FragmentHistory extends Fragment implements TextToSpeech.OnInitListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final HistoryAdapter adapter = new HistoryAdapter(getActivity(), R.layout.history_layout, listWord, mTextToSpeech);
